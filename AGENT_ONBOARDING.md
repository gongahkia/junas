...
- **Item 40 Stage B corpus expansion** — SG Stage B has a clean first pass but remains owner-review pending; the other 16 in-scope jurisdictions are Stage B-ready. Run Stage B for the next highest-value jurisdictions before making broader coverage claims.
...
Welcome to Kaypoh. Read the onboarding and architecture docs. Stage A candidate coverage is complete, SG Stage B has a clean first pass pending owner review, and the other jurisdictions remain Stage B-ready; next work should be chosen from item 40 Stage B expansion, item 82, items 87/89, item 33 remainder, or M3 depending on user priority.
