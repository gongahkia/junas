...
- **Items 121 / 70 v2 remainder** — SG seed tables, bundled UK/AU postal-population, JP/KR area-population, U.S. surname-frequency, optional generated name/role table schema support, and strict v2 scoring shipped. Next work is license-cleared bundled SG/non-US name-density, role-rarity, candidate-label exact-span promotion, and richer locality.
