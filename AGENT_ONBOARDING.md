...
- **Item 40 Stage B corpus expansion** — SG, HK, AU, MY, ID, TH, PH, VN, JP, KR, and IN Stage B are owner-approved for internal benchmarking and promotion-ready as candidate sets. CN, AE, SA, US, UK, and EU remain Stage B-ready. Run Stage B for the next highest-value jurisdictions before making broader coverage claims.
