...
- **Item 40 Stage B corpus expansion** — SG, HK, AU, MY, ID, TH, PH, VN, JP, and KR Stage B are owner-approved for internal benchmarking and promotion-ready as candidate sets. IN Stage B is evaluated clean but pending project-owner approval. CN, AE, SA, US, UK, and EU remain Stage B-ready. Run Stage B for the next highest-value jurisdictions before making broader coverage claims.
...
Welcome to Kaypoh. Read the onboarding and architecture docs. Stage A candidate coverage is complete, SG, HK, AU, MY, ID, TH, PH, VN, JP, and KR Stage B are owner-approved for internal benchmarking, IN Stage B is evaluated clean but pending project-owner approval, and CN/AE/SA/US/UK/EU remain Stage B-ready; next work should be chosen from item 40 Stage B expansion, item 82, items 87/89, item 33 remainder, or M3 depending on user priority.
