...
- **Item 40 Stage B corpus expansion** — SG, HK, AU, MY, ID, TH, PH, VN, JP, KR, IN, CN, AE, SA, and US Stage B are owner-approved for internal benchmarking and promotion-ready as candidate sets. UK and EU remain Stage B-ready and unexpanded. Run UK/EU Stage B before making broader coverage claims.
...
Welcome to Kaypoh. Read the onboarding and architecture docs. Stage A candidate coverage is complete; SG, HK, AU, MY, ID, TH, PH, VN, JP, KR, IN, CN, AE, SA, and US Stage B are owner-approved for internal benchmarking; UK/EU remain Stage B-ready. Next work should be chosen from item 40 Stage B expansion, item 82, items 87/89, item 33 remainder, or M3 depending on user priority.
