...
- **Item 40 Stage B corpus expansion** — SG and HK Stage B are owner-approved for internal benchmarking and promotion-ready as candidate sets; AU Stage B is cleanly evaluated but pending owner review; the other 14 in-scope jurisdictions are Stage B-ready. Either get AU owner approval before treating it as promotion-ready, or run Stage B for the next highest-value jurisdiction before making broader coverage claims.
