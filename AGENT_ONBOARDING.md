...
- 2026-06-09 no-key follow-up shipped: M3 LLM component-health refactor; item 33 label-gated `uk_company_number` / `eu_company_id`; item 34 address-registry, AU/EU multi-line fixture slices, and universal label-anchored `postal_address`; item 35 env-gated multilingual label-anchored semantic fallback; item 79 occupation/job-title inference; item 71/86 Japanese/Korean special-category and HK/AU/JP/KR MNPI lexicon / fixture growth; item 121/70 bundled licence-cleared UK/AU postal-population, JP/KR area-population, U.S. Census surname-frequency tables, optional generated name/role table schema support, item 54 capped LLM-raised findings, item 123 per-tenant surfacing lanes, and the Stage B candidate recall lock.
...
- Candidate Stage A is complete and Stage B has now been generated/evaluated, owner-approved, strict-runtime reconciled, and locked for all 17 in-scope jurisdiction packs under `test/fixtures/legal-corpus-candidates/`. All 17 jurisdictions pass `scripts/check_candidate_stage_gate.py --target-stage stage_b --require-promotion-ready` for internal benchmarking with strict recall/precision 1.0. The current global candidate report `/tmp/kaypoh-stage-b-reconciled.json` covers 1,428 docs / 20,063 strict labels / global ideal recall 0.4277 at strict recall/precision 1.0, with zero misses, zero unexpected findings, zero must-not violations, 1,428 approved labels, and zero pending labels. The committed lock is `test/fixtures/legal-corpus-candidates/candidate_recall.lock.json`. This is still internal benchmarking only, not procurement-grade legal advice.
...
- **Items 121 / 70 v2 remainder** — SG seed tables, bundled UK/AU postal-population, JP/KR area-population, U.S. surname-frequency, optional generated name/role table schema support, strict v2 scoring, and Stage B candidate strict-label promotion shipped. Next work is license-cleared bundled SG/non-US name-density, role-rarity, and richer locality.
...
- **Items 34 / 35 / 79 remainder** (broad addresses, semantic PII, richer inferred attributes) — conservative UK/US/HK/AU/JP/KR/EU address slices, universal label-anchored `postal_address`, env-gated multilingual label-anchored semantic fallback, and richer inferred attributes including occupation/job-title shipped; broad free-form address parsing, local NER, and relation extraction remain open.
...
Welcome to Kaypoh. Read the onboarding and architecture docs. Stage B candidate coverage is generated, cleanly evaluated, owner-approved, strict-runtime reconciled, and locked for internal benchmarking across all 17 jurisdictions. The no-cost item 120/124/125 and endpoint/defensibility batch shipped on 2026-06-06; the no-cost 122 + 33/34/79 detection slice shipped on 2026-06-07; the 2026-06-08 batch shipped Azure audit-grade wiring, item 82, and SG-only item 121/70 v2 MVP; the 2026-06-09 batch shipped M3, company-ID / address / semantic fallback slices, HK/AU/JP/KR fixture / lexicon growth, bundled UK/AU/JP/KR/US frequency tables, optional generated name/role table schema support, item 54 capped LLM-raised findings, item 123 per-tenant surfacing lanes, and Stage B candidate recall lock promotion. Next work should be chosen from the paid item 125 audit-grade sweep, item 121/70 v2 licence-cleared name/role data remainder, items 34/35/79 broad free-form parser / local NER remainder, item 48/86 fixture growth, or M1 continuation depending on user priority.
