...
- **Item 40 Stage B corpus expansion** — SG Stage B is owner-approved for internal benchmarking and promotion-ready as a candidate set; the other 16 in-scope jurisdictions are Stage B-ready. Run Stage B for the next highest-value jurisdictions before making broader coverage claims.
