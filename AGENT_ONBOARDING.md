...
- **Item 40 Stage B corpus expansion** — SG, HK, AU, and MY Stage B are owner-approved for internal benchmarking and promotion-ready as candidate sets; the other 13 in-scope jurisdictions are Stage B-ready. Run Stage B for the next highest-value jurisdictions before making broader coverage claims.
