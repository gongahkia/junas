...
- **Item 40 Stage B corpus expansion** — every in-scope jurisdiction is Stage B-ready. Run Stage B for the highest-value jurisdictions before making broader coverage claims.
...
Welcome to Kaypoh. Read the onboarding and architecture docs. Stage A candidate coverage is complete and all jurisdictions are Stage B-ready; next work should be chosen from item 40 Stage B expansion, item 82, items 87/89, item 33 remainder, or M3 depending on user priority.
