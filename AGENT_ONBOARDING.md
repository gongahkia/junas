...
- **Item 40 Stage B corpus expansion** — SG, HK, AU, MY, ID, TH, PH, VN, JP, KR, IN, CN, and AE Stage B are owner-approved for internal benchmarking and promotion-ready as candidate sets. SA, US, UK, and EU remain Stage B-ready. Run Stage B for the next highest-value remaining jurisdiction before making broader coverage claims.
