...
- Candidate Stage A is complete and Stage B has now been generated/evaluated for all 17 in-scope jurisdiction packs under `test/fixtures/legal-corpus-candidates/`. SG, HK, AU, MY, ID, TH, PH, VN, JP, KR, IN, CN, AE, SA, and US have completed owner-approved Stage B first passes for internal benchmarking and pass `scripts/check_candidate_stage_gate.py --target-stage stage_b --require-promotion-ready` with strict recall/precision 1.0. UK and EU were expanded to Stage B on 2026-06-06 and pass `--require-clean-eval` with strict recall/precision 1.0, but remain `evaluated_pending_owner_review` (`21 approved`, `63 pending` per jurisdiction) until the project owner manually reviews the new Stage B labels. The current global candidate report `/tmp/kaypoh-uk-eu-stage-b-final.json` covers 1,428 docs / 17,552 strict labels / global ideal recall 0.4234 at strict recall/precision 1.0, with zero misses, zero unexpected findings, zero must-not violations, 1,302 approved labels, and 126 pending labels. Current per-jurisdiction status is generated in `docs/candidate_corpus_status.md`; none of these Stage B candidate sets has been promoted into locked recall baselines or reviewed as procurement-grade legal advice.
...
- **Item 40 Stage B owner review** — all 17 jurisdictions have Stage B candidate sets generated and cleanly evaluated. SG, HK, AU, MY, ID, TH, PH, VN, JP, KR, IN, CN, AE, SA, and US are owner-approved for internal benchmarking and promotion-ready as candidate sets. UK and EU are clean but still pending project-owner review for their 63 new Stage B labels each; mark them approved only after the owner manually reviews them.
...
Welcome to Kaypoh. Read the onboarding and architecture docs. Stage B candidate coverage is generated and cleanly evaluated for all 17 jurisdictions; SG, HK, AU, MY, ID, TH, PH, VN, JP, KR, IN, CN, AE, SA, and US are owner-approved for internal benchmarking, while UK/EU remain pending owner review. Next work should be chosen from UK/EU owner approval, item 124/125, item 82, items 87/89, item 33 remainder, or M3 depending on user priority.
