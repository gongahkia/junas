...
const TASKS: TaskSpec[] = [
  ...
  { id: "SGLB-11", workflow: "sglb_11", name: "Citation-Hallucination", source: "Synthesised passages w/ injected fake citations", format: "passage → list of fabricated citations", metric: "per-perturbation P/R/F1", n: "40 (smoke)", status: "dataset", description: "Detect fabricated SG citations among real ones. v0.1 smoke (40 passages, 7 perturbation classes, deterministic) shipped; production dataset in #52." },
