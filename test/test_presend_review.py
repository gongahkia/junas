...
# importlib.reload(junas.backend.main), which rebinds `main.app` to a fresh FastAPI instance
...
class PreSendReviewApiTests(unittest.TestCase):
    def setUp(self):
        ...
        # junas.backend.main, which rebinds `app` to a fresh FastAPI instance with the real
