...
async def lifespan(app: FastAPI):
    ...
    for layer in layers:
        ...
        try:
            if layer == "lexicon":
                lex_mod = importlib.import_module("noupe.workflow.layer1_lexicon.filter")
                _state["models"]["lexicon"] = lex_mod.LexiconFilter()

            elif layer == "embedding":

                def _load_embedding():
                    emb_mod = importlib.import_module("noupe.workflow.layer2_embeddings.inference")
                ...
                def _load_model1():
                    m1_mod = importlib.import_module("noupe.workflow.layer4_classification.model1.inference")
                ...
                def _load_model2():
                    m2_mod = importlib.import_module("noupe.workflow.layer4_classification.model2.inference")
                ...
                def _load_mosaic():
                    mos_mod = importlib.import_module("noupe.workflow.layer5_mosaic.inference")
