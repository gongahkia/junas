...
from junas.configs.runtime import LocalDaemonSettings

LOCAL_TOKEN_HEADER = "X-Junas-Local-Token"
LOCAL_CLIENT_TOKEN_AUDIENCE = "junas-local-daemon"
LOCAL_CLIENT_TOKEN_ISSUER = "junas-local"
KEYCHAIN_ACCOUNT = "default"
KEYCHAIN_SERVICE = "junas-local-daemon-token"
DEFAULT_TOKEN_FILE = Path.home() / ".junas" / "local_daemon_token"
