...
The scanner is intentionally stdlib-first so junas-local does not gain heavy parser
...
from junas.review.image_scan import ImageCandidate, ImageLocator, image_mime_from_name
