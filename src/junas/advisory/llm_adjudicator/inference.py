...
class LocalLLMAdjudicator:
    ...
    def adjudicate(
        ...
        *,
        ...
        # CPU/GPU inside the junas-server process. Delegate to LocalDistilledAdjudicator.
        if self.provider == "local_distilled":
        ...
        *,
        ...
        if not self.distilled_adapter_path:
            return {
                ...
                "unverified_claims": [],
                "review_recommendation": (
                    "provider=local_distilled requires JUNAS_LLM_DISTILLED_ADAPTER_PATH "
