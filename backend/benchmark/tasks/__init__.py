...
from benchmark.tasks import sglb_13  # noqa: F401  (registration side-effect)
from benchmark.tasks import sglb_14  # noqa: F401  (registration side-effect)
...
__all__ = ["sglb_01", "sglb_02", "sglb_04", "sglb_05", "sglb_06", "sglb_07", "sglb_08", "sglb_11", "sglb_12", "sglb_13", "sglb_14", "sglb_15", "sglb_16"]
