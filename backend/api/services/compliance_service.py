...
DEFAULT_SG_RULES: list[ComplianceRule] = [
    ...
    ComplianceRule("roc-2021-service", "Rules of Court 2021 Service", "Procedure", "Procedural references should align with Rules of Court 2021", ["rules of court", "originating claim", "originating application"], "low"),
]


def normalize_jurisdiction(value: str | None) -> str:
    # SG-only after pivot; registry pattern preserved for future Commonwealth adjacency.
    del value
    return "sg"
