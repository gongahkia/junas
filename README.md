...
<p align="center">
  <img src="./docs/assets/demo/hero-ascii-redaction.svg" width="90%" alt="ASCII redaction demo showing an iTerm-style fake AWS secret beside a redacted virtual-camera preview">
</p>
<p align="center">
  <sub>8-second README-friendly SVG loop · fake credentials only · terminal and redacted preview shown side by side</sub>
</p>
...
The OBS source-plugin evaluation is documented in [`docs/integrations/obs-source-plugin.md`](./docs/integrations/obs-source-plugin.md).
...
Homebrew tap naming and cask publication gates are documented in [`docs/homebrew-cask.md`](./docs/homebrew-cask.md).
