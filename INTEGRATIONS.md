...
|---|---|---|---|---|
| Direct API | `core` | [`docs/integrations/direct-api.md`](./docs/integrations/direct-api.md), [`docs/api/python_client.md`](./docs/api/python_client.md) | [`src/kaypoh/backend/`](./src/kaypoh/backend/), [`src/kaypoh/client.py`](./src/kaypoh/client.py) | Use when no UI adapter is needed. |
...
| DMS hooks | `experimental` | [`docs/integrations/dms.md`](./docs/integrations/dms.md) | [`src/kaypoh/integrations/dms.py`](./src/kaypoh/integrations/dms.py), [`scripts/scan_dms_manifest.py`](./scripts/scan_dms_manifest.py) | Service-side upload/check-in review; no vendor SDK is shipped here. |
