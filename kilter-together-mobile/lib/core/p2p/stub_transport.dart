...
class StubTransport implements P2pTransport {
  final StreamController<P2pMessage> _msg = StreamController<P2pMessage>.broadcast();
  final StreamController<P2pPeer> _disc = StreamController<P2pPeer>.broadcast();
  final StreamController<P2pConnectionChange> _conn = StreamController<P2pConnectionChange>.broadcast();
  ...
  Future<void> startAdvertising({required String displayName, required String serviceId}) async {
    throw UnsupportedError('P2P advertising is not supported on this platform. nearby_connections requires Android.');
  }
  @override
  Future<void> stopAdvertising() async {}
  @override
  Future<void> startDiscovery({required String serviceId}) async {
    throw UnsupportedError('P2P discovery is not supported on this platform. nearby_connections requires Android.');
  }
  @override
  Future<void> stopDiscovery() async {}
  @override
  Future<void> connectToPeer(P2pPeer peer) async {
    throw UnsupportedError('P2P connections are not supported on this platform.');
  }
  @override
