...
| `quasi_identifier_combination` | PDPA s2 + GDPR Recital 26 + CCPA §1798.140(v) + Sweeney 2000 | low/medium/high | strict `singling_out_v2` scorer uses bundled/operator frequency tables where available and a deterministic identifying-weight fallback elsewhere; audit_grade keeps the structural ≥3 quasi-ID cluster fallback |
