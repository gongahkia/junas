...
- **Jurisdiction-age-cliff minors detector** — DPDPA India s2(f) + s9 (<18) / GDPR Art 8 (<16 default; member-states may lower to 13) / PIPL China Art 31 (<14) / COPPA US 16 CFR Part 312 (<13) / PDPC SG Children's Data Advisory Guidelines (<18) / UK ICO Children's Code (<18) / AU OAIC Children's Code (<18 pending Dec 2026) / HK PCPD Minors Note (<18) / UAE Wadeema Law (<18) / KSA Saudi Child Protection Law (<18) / LGPD Art 14 (<18). Implemented as `minor_data_reference` with single rule + per-jurisdiction-resolved severity from `_MINOR_AGE_CLIFFS` map (item 107). Strictest applicable cliff wins. Explicit age regex + minor/juvenile lexicon + school-grade markers (SG primary/secondary, UK Year N, US grade N) + verifiable-parental-consent vocabulary.
