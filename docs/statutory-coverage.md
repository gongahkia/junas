...
- **Special-category PII v1 seed (religion / union / political)** — GDPR Art 9(1) verbatim list + PIPA Korea Art 23 + APPI Japan Art 2(3) "creed" + LGPD Brazil Art 5(II) + PIPL China Art 28 (religion only) + UAE PDPL Art 15 + KSA PDPL Art 6 + PDPC SG Advisory Guidelines on Key Concepts (Oct 2024). Implemented as `religious_belief` + `trade_union_membership` + `political_opinion` rules with strict context anchors (item 98). DPDPA India has no sensitive-data tier; SDF designation (s10) is the escalation. Per-category opt-out via `KAYPOH_SPECIAL_CATEGORY_DISABLE=religion,union,political`. Health / biometric / sex-life deferred to items 105/106/108. KSA/UAE: detector flags neutrally — does not editorialise on jurisdiction-specific permissibility (state-religion / anti-discrimination law analysis is downstream).
...
| Special-category PII (health / biometric / sex life / racial origin) | no detector | 71 / 105 / 106 / 108 |
