...
Kaypoh v0.1 exposes root endpoints such as `/review`, `/pseudonymize`, `/anonymize`, `/redact`, `/redact-pii`, `/hold-until-public`, `/cite-public-source`, `/request-approval`, `/reidentify`, `/documents/scrub`, and `/classify`. The OpenAPI schema is the contract source for generated clients.
