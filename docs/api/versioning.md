...
Kaypoh v0.1 exposes root endpoints such as `/review`, `/pseudonymize`, `/anonymize`, `/redact`, `/reidentify`, `/documents/scrub`, and `/classify`. The OpenAPI schema is the contract source for generated clients.
