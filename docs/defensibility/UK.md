# United Kingdom (UK) Defensibility Report

> Generated 2026-06-06 from `src/kaypoh/review/jurisdictions_data/UK.toml`. Internal benchmarking and procurement-support artifact only; not legal advice.
...
- UK_GDPR_PERSONAL_DATA

Runtime MNPI rule families:

- UK_MAR_INSIDE_INFORMATION

Jurisdiction-local recognizers:

| Rule | Severity | Defensible basis |
| --- | --- | --- |
| `uk_nin` | high | UK National Insurance Number |
