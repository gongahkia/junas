...
|---|---:|---|---|
| default legal corpus | 122 | `test/fixtures/legal-corpus/recall.lock.json` | Hand-labelled SG/legal-contract seed corpus. |
| adversarial corpus | 117 | `test/fixtures/legal-corpus-adversarial/recall_adversarial.lock.json` | Negative, obfuscated, and multilingual probes. |
...
|---|---:|---|---:|---:|
| default legal corpus | 122 | `definitive_agreement` | 1.0000 | 1.0000 |
| default legal corpus | 122 | `email_address` | 1.0000 | 1.0000 |
| default legal corpus | 122 | `embargo_marker` | 1.0000 | 1.0000 |
| default legal corpus | 122 | `financial_amount` | 0.9512 | 1.0000 |
| default legal corpus | 122 | `financial_percentage` | 1.0000 | 1.0000 |
| default legal corpus | 122 | `information_barrier_marker` | 1.0000 | 1.0000 |
| default legal corpus | 122 | `insider_list_marker` | 1.0000 | 1.0000 |
| default legal corpus | 122 | `large_number` | 1.0000 | 1.0000 |
| default legal corpus | 122 | `material_adverse_change` | 1.0000 | 1.0000 |
| default legal corpus | 122 | `named_person` | 0.9766 | 1.0000 |
| default legal corpus | 122 | `nonpublic_marker` | 1.0000 | 1.0000 |
| default legal corpus | 122 | `passport_number` | 1.0000 | 1.0000 |
| default legal corpus | 122 | `phone_number` | 0.9883 | 1.0000 |
| default legal corpus | 122 | `sg_nric_fin` | 1.0000 | 1.0000 |
| default legal corpus | 122 | `sg_postal_address` | 1.0000 | 1.0000 |
| default legal corpus | 122 | `sg_uen` | 1.0000 | 1.0000 |
| default legal corpus | 122 | `transaction_codename` | 1.0000 | 1.0000 |
| adversarial corpus | 117 | `bank_account` | 0.0000 | not locked |
| adversarial corpus | 117 | `definitive_agreement` | 0.9474 | 1.0000 |
| adversarial corpus | 117 | `email_address` | 1.0000 | 1.0000 |
| adversarial corpus | 117 | `embargo_marker` | 1.0000 | 1.0000 |
| adversarial corpus | 117 | `financial_amount` | 0.9910 | 1.0000 |
| adversarial corpus | 117 | `financial_percentage` | 1.0000 | 1.0000 |
| adversarial corpus | 117 | `large_number` | 0.8182 | 1.0000 |
| adversarial corpus | 117 | `material_event` | 0.0000 | not locked |
| adversarial corpus | 117 | `named_person` | 0.9777 | 1.0000 |
| adversarial corpus | 117 | `nonpublic_marker` | 1.0000 | 1.0000 |
| adversarial corpus | 117 | `phone_number` | 0.9529 | 1.0000 |
| adversarial corpus | 117 | `sg_nric_fin` | 1.0000 | 1.0000 |
| adversarial corpus | 117 | `sg_postal_address` | 1.0000 | 1.0000 |
| adversarial corpus | 117 | `sg_uen` | 1.0000 | 1.0000 |
| adversarial corpus | 117 | `transaction_codename` | 0.9091 | 1.0000 |
