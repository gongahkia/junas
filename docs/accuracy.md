...
|---|---:|---|---|
| default legal corpus | 125 | `test/fixtures/legal-corpus/recall.lock.json` | Hand-labelled SG/legal-contract seed corpus. |
| adversarial corpus | 118 | `test/fixtures/legal-corpus-adversarial/recall_adversarial.lock.json` | Negative, obfuscated, and multilingual probes. |
...
|---|---:|---|---:|---:|
| default legal corpus | 125 | `cyber_incident_pre_disclosure` | 1.0000 | 1.0000 |
| default legal corpus | 125 | `definitive_agreement` | 1.0000 | 1.0000 |
| default legal corpus | 125 | `dpt_pre_listing_marker` | 1.0000 | 1.0000 |
| default legal corpus | 125 | `email_address` | 1.0000 | 1.0000 |
| default legal corpus | 125 | `embargo_marker` | 1.0000 | 1.0000 |
| default legal corpus | 125 | `esg_climate_pre_disclosure` | 1.0000 | 1.0000 |
| default legal corpus | 125 | `esg_target_revision` | 1.0000 | 1.0000 |
| default legal corpus | 125 | `financial_amount` | 0.9512 | 1.0000 |
| default legal corpus | 125 | `financial_percentage` | 1.0000 | 1.0000 |
| default legal corpus | 125 | `information_barrier_marker` | 1.0000 | 1.0000 |
| default legal corpus | 125 | `insider_list_marker` | 1.0000 | 1.0000 |
| default legal corpus | 125 | `large_number` | 1.0000 | 1.0000 |
| default legal corpus | 125 | `material_adverse_change` | 1.0000 | 1.0000 |
| default legal corpus | 125 | `named_person` | 0.9766 | 1.0000 |
| default legal corpus | 125 | `nonpublic_marker` | 1.0000 | 1.0000 |
| default legal corpus | 125 | `passport_number` | 1.0000 | 1.0000 |
| default legal corpus | 125 | `phone_number` | 0.9883 | 1.0000 |
| default legal corpus | 125 | `sg_nric_fin` | 1.0000 | 1.0000 |
| default legal corpus | 125 | `sg_postal_address` | 1.0000 | 1.0000 |
| default legal corpus | 125 | `sg_uen` | 1.0000 | 1.0000 |
| default legal corpus | 125 | `transaction_codename` | 1.0000 | 1.0000 |
| adversarial corpus | 118 | `bank_account` | 0.0000 | not locked |
| adversarial corpus | 118 | `definitive_agreement` | 0.9474 | 1.0000 |
| adversarial corpus | 118 | `email_address` | 1.0000 | 1.0000 |
| adversarial corpus | 118 | `embargo_marker` | 1.0000 | 1.0000 |
| adversarial corpus | 118 | `financial_amount` | 0.9910 | 1.0000 |
| adversarial corpus | 118 | `financial_percentage` | 1.0000 | 1.0000 |
| adversarial corpus | 118 | `large_number` | 0.8182 | 1.0000 |
| adversarial corpus | 118 | `material_event` | 0.0000 | not locked |
| adversarial corpus | 118 | `named_person` | 0.9777 | 1.0000 |
| adversarial corpus | 118 | `nonpublic_marker` | 1.0000 | 1.0000 |
| adversarial corpus | 118 | `phone_number` | 0.9529 | 1.0000 |
| adversarial corpus | 118 | `sg_nric_fin` | 1.0000 | 1.0000 |
| adversarial corpus | 118 | `sg_postal_address` | 1.0000 | 1.0000 |
| adversarial corpus | 118 | `sg_uen` | 1.0000 | 1.0000 |
| adversarial corpus | 118 | `transaction_codename` | 0.9091 | 1.0000 |
