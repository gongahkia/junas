...
| Next | [#12](https://github.com/gongahkia/junas/issues/12) optional rule-pack import. | Needs reproducible evidence, bounded claims, or an explicit decision note before implementation is promoted. |
