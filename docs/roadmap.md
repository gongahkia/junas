...
|---|---|---|
| Now | [#84](https://github.com/gongahkia/junas/issues/84) hosted deterministic demo, [#85](https://github.com/gongahkia/junas/issues/85) hosted playground verification, [#76](https://github.com/gongahkia/junas/issues/76) product usability pass, [#1](https://github.com/gongahkia/junas/issues/1) README first-run cleanup. | Must improve current Junas launch evidence without widening product scope. |
| Next | [#32](https://github.com/gongahkia/junas/issues/32) release tags/changelogs, [#34](https://github.com/gongahkia/junas/issues/34) distribution paths, [#12](https://github.com/gongahkia/junas/issues/12) optional rule-pack import. | Needs reproducible evidence, bounded claims, or an explicit decision note before implementation is promoted. |
